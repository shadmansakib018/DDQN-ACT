...
BASE_PORT = 3000
jar_path = "24HOUR-SIM-A3C.jar"
MODEL_PATH = "./checkpoints/checkpoint_step_7400_A2C.pth"
num_epochs = 100
MAX_CONCURRENT = 2  # Limit to 2 concurrent Java processes

EXPERIMENT_CONDITIONS = {
    # "RL-1": [MODEL_PATH, BASE_PORT+1, 50,  4, num_epochs, "A3C-10VM-B50"],
    # "RL-2": [MODEL_PATH, BASE_PORT+2, 100, 4, num_epochs, "A3C-10VM-B100"],
    # "RL-3": [MODEL_PATH, BASE_PORT+3, 150, 4, num_epochs, "A3C-10VM-B150"],
    # "RL-4": [MODEL_PATH, BASE_PORT+4, 200, 4, num_epochs, "A3C-10VM-B200"],
    # "RL-5": [MODEL_PATH, BASE_PORT+5, 250, 4, num_epochs, "A3C-10VM-B250"],
    # "RL-6": [MODEL_PATH, BASE_PORT+6, 300, 4, num_epochs, "A3C-10VM-B300"],
    # "RL-7": [MODEL_PATH, BASE_PORT+7, 350, 4, num_epochs, "A3C-10VM-B350"],
    # "RL-8": [MODEL_PATH, BASE_PORT+8, 400, 4, num_epochs, "A3C-10VM-B400"],
    # "RL-9": [MODEL_PATH, BASE_PORT+9, 450, 4, num_epochs, "A3C-10VM-B450"],
    # "RL-10":[MODEL_PATH, BASE_PORT+10,500, 4, num_epochs, "A3C-10VM-B500"],
...
for name, (model_path, port, _, _ ) in EXPERIMENT_CONDITIONS.items(): # uncomment for 24 hour simulations
    agent = ACAgent(model_path)
    app = create_flask_app(agent, port)
    thread = threading.Thread(target=serve, args=(app,), kwargs={"host": "0.0.0.0", "port": port})
    thread.daemon = True
    thread.start()
